...
#elif defined(ACF_PLATFORM_MWERKS_POWERPC_MACOS10) || defined(ACF_PLATFORM_GCC_POWERPC_MACOS10) || defined(ACF_PLATFORM_GCC_INTEL_MACOS10) || defined(ACF_PLATFORM_INTEL_INTEL_MACOS10) || defined(ACF_OS_LINUX) || defined(ACF_OS_FREEBSD) || defined(ACF_PLATFORM_ARM_IOS)
  	#define ACFMETHODCALLTYPE
